...
export type AddNoteMutation = {
  ...
  addNote: {
    ...
    error?: { __typename?: "Error"; property: string; message: string } | null;
  };
};
...
export type CreateNotesListMutation = {
  ...
  createNotesList: {
    __typename?: "NotesListResponse";
    notesList?: { __typename?: "NotesList"; id: string; title: string } | null;
    error?: { __typename?: "Error"; property: string; message: string } | null;
  };
};
...
export type LogoutMutation = {
  __typename?: "Mutation";
  logout?: { __typename?: "User"; username: string } | null;
};
...
export type UpdateCollectionMutation = {
  ...
  updateCollection: {
    ...
    collection?: {
      ...
      lists: Array<{ __typename?: "NotesList"; id: string; title: string }>;
    } | null;
    error?: { __typename?: "Error"; property: string; message: string } | null;
  };
};
...
export function useAddNoteMutation() {
  return Urql.useMutation<AddNoteMutation, AddNoteMutationVariables>(
    AddNoteDocument
  );
}
...
export function useDeleteNotesListMutation() {
  return Urql.useMutation<
    DeleteNotesListMutation,
    DeleteNotesListMutationVariables
  >(DeleteNotesListDocument);
}
...
export function useCollectionsQuery(
  ...
  return Urql.useQuery<CollectionsQuery, CollectionsQueryVariables>({
...
export function useNotesListsQuery(
  options: Omit<Urql.UseQueryArgs<NotesListsQueryVariables>, "query">
) {
  return Urql.useQuery<NotesListsQuery, NotesListsQueryVariables>({
    query: NotesListsDocument,
    ...options,
  });
}
...
export function useNotesListQuery(
  options: Omit<Urql.UseQueryArgs<NotesListQueryVariables>, "query">
) {
  return Urql.useQuery<NotesListQuery, NotesListQueryVariables>({
    query: NotesListDocument,
    ...options,
  });
}
