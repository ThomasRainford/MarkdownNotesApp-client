...
db.user.insertMany([
  {
    ...
    following: ["222222222222222222222222"],
    followers: ["222222222222222222222222"],
    upvoted: ["c44444444444444444444444"],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    username: "User02",
    password: "$argon2i$v=19$m=16,t=2,p=1$cXdlcnR5dWk$96NSCvpc+wrSDbiZgCJrxg",
    following: ["111111111111111111111111"],
    followers: ["111111111111111111111111"],
    upvoted: ["c11111111111111111111111"],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
]);
